...
RUN apt update \
    && apt remove vim-* -y \
    && apt install -y --no-install-recommends bash-completion python3 python3-pip wget jq curl vim zip git unzip xz-utils pkg-config libssl-dev ca-certificates libatomic1 ripgrep \
